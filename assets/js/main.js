const translations = {
  es: {
    ...
    proj3_text: "Este proyecto contiene un script de Bash para automatizar la creación y gestión de usuarios, grupos y permisos en un entorno Linux, siguiendo principios de Infraestructura como Código (IaC).",
  ...
  en: {
    ...
    proj3_text: "This project contains a Bash script to automate the creation and management of users, groups, and permissions in a Linux environment, following Infrastructure as Code (IaC) principles.",
  ...
  pt: {
    ...
    proj3_text: "Este projeto contém um script Bash para automatizar a criação e gestão de usuários, grupos e permissões em um ambiente Linux, seguindo princípios de Infraestrutura como Código (IaC).",
